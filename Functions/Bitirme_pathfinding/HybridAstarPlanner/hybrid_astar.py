...
def design_obstacles(x, y, indices_np):
    ox, oy = [], []
...
def call_Path(current_x,current_y,current_yaw,x_goal,y_goal,yaw_goal):
    print("start!")
    
    with open("Bitirme_pathfinding\HybridAstarPlanner\sonuc_matrisi.txt", "r") as dosya:
        satirlar = dosya.readlines()
    ...
    ox, oy = design_obstacles(x, y, indices_np/2)
...
def main():
    x,y,yaw,direction = call_Path(40,40,90,40,350,90)
